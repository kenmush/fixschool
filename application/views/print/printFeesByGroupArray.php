        ...
        <div id="content" class="col-lg-12 col-sm-12 ">
                        ...
                        <div class="col-xs-9 text-left">
                            ...
                            <address>
                                <strong><?php
                                    ...
                                    echo $this->customlib->getFullName($feearray[0]->firstname,
                                            $feearray[0]->middlename, $feearray[0]->lastname, $sch_setting->middlename,
                            ...
                            <address>
                                <strong>Date: <?php
                                    ...
                                    echo date($this->customlib->getSchoolDateFormat(),
                                            $this->customlib->dateyyyymmddTodateformat($date));
                                    ?></strong><br/>
                                    ...
                                    foreach ($feearray as $fee_key => $feeList) {
                                        ...
                                        if (is_object($fee_deposits)) {
                                            foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                ?>
                                                <tr class="white-td">
                                                    <td colspan="2" class="text-right"><img
                                                    ...
                                                    <td class="text text-right"><?php echo($currency_symbol.number_format($fee_deposits_value->amount,
                                                                        2, '.', '')); ?></td>

                                                    <td class="text text-right"><?php echo($currency_symbol.number_format($fee_deposits_value->amount_discount,
                                                                        2, '.', '')); ?></td>
                                                    <td></td>
            ...
            <div class="row header ">
                <div class="col-sm-12">
                    <strong>
                        <p>
                            Overpayment Amount: KES <?php echo $overpayment ?>
                        </p>
                                        ...
                                        foreach ($feearray as $fee_key => $feeList) {
                                            ...
                                            <tr class="dark-gray">
                                                ...
                                                <td class="">
                                                    ...
                                                    } elseif (!empty($feeList->amount_detail)) {
                                            ...
                                            if (is_object($fee_deposits)) {
                                                foreach ($fee_deposits as $fee_deposits_key => $fee_deposits_value) {
                                                    ?>
                                                    <tr class="white-td">
                                                        <td colspan="5" class="text-right"><img
                                                                    src="<?php echo base_url(); ?>backend/images/table-arrow.png"
                                                                    alt=""/></td>
                                                        <td class="text text-center">
