        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form action="<?php echo site_url('studentfee/reportbyname') ?>" method="post"
                                ...
                                foreach ($student_due_fee as $student_key => $student) {
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <table class="table table-striped mb0 font13">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <b class="text-danger"> <?php echo $student['rte']; ?> </b>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <p class="dates"><?php echo $this->lang->line('date'); ?>
                                                : <?php echo date($this->customlib->getSchoolDateFormat()); ?></p></div>
                                    </div>
...
//                                                        } else {
//
//                                                            echo date($this->customlib->getSchoolDateFormat(),
//                                                                    $this->customlib->dateyyyymmddTodateformat($fee_value->due_date));
//                                                        }
//                                                        ?>
<!--                                                    </td>-->
